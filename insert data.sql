...
INSERT INTO `tutor` VALUEs (1, 'John', 'Cena', 'WWE', 'CenaJ@wwe.com', 'u cant see me', '2000-11-18', '{"Background": {"Id": 1, "Name": "Intro to AI", "GPA": 3.75, "Id": 2, "Name": "Intro to Computing", "GPA": 3.9}, "Description": "I am handsome"}'),
(2, 'John', 'Wick', 'PencilKiller', 'JohnPencil@gmail.com', 'doggy cute', '1998-02-23', '{"Background": {"Id": 4, "Name": "Micro", "GPA": 4.0}, "Description": "Study or else die"}');
